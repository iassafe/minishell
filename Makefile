...
#    Updated: 2023/08/12 09:48:53 by iassafe          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = minishell.c syntax+list_utils.c split.c syntax_utils.c split_utils.c \
	...
	cd_without.c ulist_env.c em_xec_env.c split_libft.c pipe.c
...
OBJ = minishell.o syntax+list_utils.o split.o syntax_utils.o split_utils.o \
	...
	cd_without.o ulist_env.o em+xec_env.o split_libft.o pipe.o
